...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "5720b07d-5032-4987-9c40-391434d3a331",
...
const _lazy_3v2fr2 = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_3v2fr2, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_3v2fr2, lazy: true, middleware: false, method: undefined }
];
